...
def test_api_image_with_square_box(client, req_data):
    """
...
def test_api_image_with_vertical_rectangle(client, req_data):
    """
...
def test_api_image_with_horizontal_rectangle(client, req_data):
    """
...
def test_400_by_small_box(client, req_data):
    """
...
def test_400_by_wrong_width(client, req_data):
    """
...
def test_400_by_wrong_height(client, req_data):
    """
...
def test_400_by_wrong_text_color(client, req_data):
    """
...
def test_400_by_wrong_image_url(client, req_data):
    """
...
def test_400_by_ghost_image_url(client, req_data):
    """
